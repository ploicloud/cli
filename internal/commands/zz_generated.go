...
func registerGenerated(root *cobra.Command, c *client.Client) {
	...
	cApplicationsBuildConfigUpdate := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "build_commands", Type: "array:string", Required: false, Desc: ""},
			{Name: "init_commands", Type: "array:string", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsDeploy := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "branch", Type: "string", Required: false, Desc: ""},
			{Name: "skip_build", Type: "boolean", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsDismissNotification := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "type", Type: "string", Required: true, Desc: "one of: getting_started, deployment_needed"},
		},
	})
	...
	cApplicationsDomainsStore := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "domain", Type: "string", Required: true, Desc: ""},
			{Name: "force_apply", Type: "boolean", Required: false, Desc: ""},
			{Name: "skip_dns_check", Type: "boolean", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsExec := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "command", Type: "string", Required: true, Desc: ""},
			{Name: "instance", Type: "string", Required: true, Desc: ""},
		},
	})
	...
	cApplicationsNetworksUpdate := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "network_ids", Type: "array:integer", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsPhpConfigUpdate := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "php_extensions", Type: "array:string", Required: false, Desc: ""},
			{Name: "php_image_variant", Type: "string", Required: false, Desc: "one of: fpm-nginx, frankenphp"},
			{Name: "php_settings", Type: "array:string", Required: false, Desc: ""},
			{Name: "php_version", Type: "string", Required: false, Desc: "one of: 8.5, 8.4, 8.3, 8.2, 8.1, 8.0, 7.4"},
			{Name: "start_command", Type: "string", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsRepositoryUpdate := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "default_branch", Type: "string", Required: false, Desc: ""},
			...
			{Name: "social_account_id", Type: "integer", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsResourcesUpdate := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "memory_request", Type: "string", Required: true, Desc: ""},
			{Name: "replicas", Type: "integer", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsRollback := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "deployment_id", Type: "integer", Required: true, Desc: ""},
		},
	})
	...
	cApplicationsServicesStore := buildCmd(c, opSpec{
		...
		BodyParams: []paramDef{
			...
			{Name: "settings", Type: "object", Required: false, Desc: ""},
			{Name: "type", Type: "string", Required: true, Desc: ""},
			{Name: "version", Type: "string", Required: false, Desc: ""},
			{Name: "settings.command", Type: "string", Required: false, Desc: ""},
			{Name: "settings.memory_request", Type: "string", Required: false, Desc: ""},
			{Name: "settings.replicas", Type: "integer", Required: false, Desc: ""},
			{Name: "settings.volume_size", Type: "string", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsServicesUpdate := buildCmd(c, opSpec{
		...
		BodyParams: []paramDef{
			...
			{Name: "version", Type: "string", Required: false, Desc: ""},
			{Name: "settings.command", Type: "string", Required: false, Desc: ""},
			{Name: "settings.extensions", Type: "array:string", Required: false, Desc: ""},
			{Name: "settings.maxmemory_policy", Type: "string", Required: false, Desc: "one of: noeviction, allkeys-lru, allkeys-lfu, allkeys-random, volatile-lru, volatile-lfu, volatile-ttl, volatile-random"},
			{Name: "settings.plugins", Type: "array:string", Required: false, Desc: ""},
			{Name: "settings.volume_size", Type: "integer", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsSettingsUpdate := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "health_check_path", Type: "string", Required: false, Desc: ""},
			{Name: "nodejs_version", Type: "string", Required: false, Desc: "one of: none, 20, 22, 24"},
			{Name: "scheduler_enabled", Type: "boolean", Required: false, Desc: ""},
			{Name: "webroot_path", Type: "string", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsStore := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "application_type", Type: "string", Required: true, Desc: "one of: laravel, wordpress, statamic, craftcms, nodejs, php"},
			{Name: "application_version", Type: "string", Required: false, Desc: ""},
			{Name: "default_branch", Type: "string", Required: false, Desc: ""},
			{Name: "name", Type: "string", Required: true, Desc: ""},
			{Name: "php_version", Type: "string", Required: false, Desc: "one of: 8.5, 8.4, 8.3, 8.2, 8.1, 8.0, 7.4"},
			...
			{Name: "repository_owner", Type: "string", Required: false, Desc: ""},
			{Name: "repository_url", Type: "string", Required: false, Desc: ""},
			{Name: "scheduled_deletion_at", Type: "string", Required: false, Desc: ""},
			{Name: "social_account_id", Type: "integer", Required: false, Desc: ""},
			{Name: "source_type", Type: "string", Required: false, Desc: "one of: git, upload"},
			{Name: "statamic_use_git_integration", Type: "boolean", Required: false, Desc: ""},
			{Name: "webroot_path", Type: "string", Required: false, Desc: ""},
			{Name: "wordpress_use_volume", Type: "boolean", Required: false, Desc: ""},
		},
	})
	...
	cApplicationsVolumesStore := buildCmd(c, opSpec{
		...
		BodyParams: []paramDef{
			...
			{Name: "size", Type: "integer", Required: true, Desc: ""},
		},
	})
	...
	cTeamsNetworksStore := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "description", Type: "string", Required: false, Desc: ""},
			{Name: "name", Type: "string", Required: true, Desc: ""},
		},
	})
	...
	cTeamsNetworksUpdate := buildCmd(c, opSpec{
		...
		BodyParams: []paramDef{
			{Name: "description", Type: "string", Required: false, Desc: ""},
			{Name: "name", Type: "string", Required: false, Desc: ""},
		},
	})
	...
	cToolsPdfConvertHtml := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "html", Type: "string", Required: true, Desc: ""},
			{Name: "landscape", Type: "boolean", Required: false, Desc: ""},
			{Name: "marginBottom", Type: "string", Required: false, Desc: ""},
			{Name: "marginLeft", Type: "string", Required: false, Desc: ""},
			{Name: "marginRight", Type: "string", Required: false, Desc: ""},
			{Name: "marginTop", Type: "string", Required: false, Desc: ""},
			{Name: "paperHeight", Type: "string", Required: false, Desc: ""},
			{Name: "paperWidth", Type: "string", Required: false, Desc: ""},
			{Name: "printBackground", Type: "boolean", Required: false, Desc: ""},
			{Name: "scale", Type: "number", Required: false, Desc: ""},
		},
	})
	...
	cToolsPdfConvertMarkdown := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "html", Type: "string", Required: false, Desc: ""},
			{Name: "markdown", Type: "string", Required: true, Desc: ""},
		},
	})
	...
	cToolsScreenshotHtml := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "format", Type: "string", Required: false, Desc: "one of: png, jpeg"},
			{Name: "height", Type: "integer", Required: false, Desc: ""},
			{Name: "html", Type: "string", Required: true, Desc: ""},
			{Name: "width", Type: "integer", Required: false, Desc: ""},
		},
	})
	...
	cUserSwitchTeam := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "team_id", Type: "integer", Required: true, Desc: ""},
		},
	})
	...
	cUserTokensStore := buildCmd(c, opSpec{
		...
		QueryParams: []paramDef{},
		BodyParams: []paramDef{
			{Name: "expires_at", Type: "string", Required: false, Desc: ""},
			{Name: "name", Type: "string", Required: true, Desc: ""},
